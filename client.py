...
class FtxClient:
    ...
    def get_orderbook(self, market: str, depth: int = 1) -> dict:
...
# POST /subaccounts/transfer           
    def transfer_fund_mainsub(self, coin: str, size: float, source: str, destination: str) -> dict:
    ...
    def transfer_fund_submain(self, coin: str, size: float, source: str, destination: str) -> dict:
        return self._post('subaccounts/transfer', {'coin': coin,
                                     'size': size,
                                     'source': source,
                                     'destination': destination,                                     
    ...
    def transfer_fund(self, coin: str, size: float, source: str, destination: str) -> dict:
        return self._post('subaccounts/transfer', {'coin': coin,
                                     'size': size,
                                     'source': source,
                                     'destination': destination,                                     
